...
> DOI: []()
> 
> Correspondence: [ahrensm@janelia.hhmi.org](mailto:ahrensm@janelia.hhmi.org)
...
This repository contains the **analysis and figure-generation code** to **reproduce manuscript figures** and **inspect intermediate analysis outputs**.


---

## Related repositories
WARP is supported by several dedicated repositories that implement key parts of the processing pipeline. 
This repository focuses on **manuscript analysis + figure generation**, the data used to generate these analyses and 
figures use the output of the preprocessing steps implemented in the packages below applied to the raw imaging data.
...
All (preprocessed) data generated by this study have been deposited at figshare:
...
Raw imaging data is available upon reasonable request.
...
```bash
git clone https://github.com/zebrafishWARP/WARP
```
